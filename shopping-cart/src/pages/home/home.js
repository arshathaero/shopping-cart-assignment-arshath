  ...
  return (
    <div className={styles.home}>
      <section className={styles.home__offer}>
        <Carousal items={offerBanner} delay={3000} />
      </section>
      <section className={styles.home__category}>
        {categoryData?.sort((a,b)=>a.order - b.order).map((element, index) => (
          element?.imageUrl  ? <div className={styles.home__category__categoryWrapper} key={index}>
